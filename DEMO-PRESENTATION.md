...
```yaml
# .github/workflows/ci-cd.yml (Approach 2 - Production)
    ...
    steps:
      ...
      - name: Sign image with Cosign
        ...
        run: |
          ...
          # Sign the image (signature stored in Docker Hub alongside image)
...
metadata:
  ...
  annotations:
    ...
    argocd-image-updater.argoproj.io/image-list: app=pranathinallamilli/java-demo-app
...
spec:
  ...
  rules:
    - name: verify-image-signature
      ...
      verifyImages:
        - imageReferences:
            - "pranathinallamilli/java-demo-app:*"
          attestors:
            - entries:
                - keys:
                    publicKeys: |
...
|-------|------|-------------|------|
| 1. Build | Trivy | Scans image for CVEs (CRITICAL/HIGH) | During CI pipeline |
